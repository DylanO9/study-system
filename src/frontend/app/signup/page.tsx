    ...
    <main className="min-h-screen flex items-center justify-center bg-stone-100 font-sans px-4">
      <div className="w-full max-w-sm">
        ...
        <header className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-stone-800 tracking-tight">Welcome</h1>
          <p className="text-sm text-stone-500 mt-1">Sign up to begin studying</p>
        </header>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
          <form id="login" className="space-y-5">
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-stone-600 uppercase tracking-wider" htmlFor="first-name">
                First Name
              </label>
              <input
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-stone-600 uppercase tracking-wider" htmlFor="last-name">
                Last Name
              </label>
              <input
                className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-50 text-stone-800 text-sm placeholder:text-stone-400 outline-none focus:border-stone-400 focus:bg-white transition-colors"
        ...
        <p className="text-center text-xs text-stone-400 mt-6">
          ...
          <a href="/login" className="text-stone-600 hover:text-stone-800 font-medium transition-colors">
            Login
          </a>
        </p>
